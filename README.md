...
The initial Paris collection contains **nineteen draft models**. Structural checks pass; visual, map-integration and rights reviews remain pending. The approved catalogue is empty until those reviews are completed. This is not an automatic photographs-to-models service.
